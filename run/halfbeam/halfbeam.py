...
@click.option('--ymod2', default=1e10)
@click.option('--prat', default=0.25)
@click.option('--force1', default=0.0)
@click.option('--force2', default=0.0)
@click.option('--length', default=5)
@util.common_args
def solve(ymod1, ymod2, prat, force1, force2, length):
    case = get_case(length)
    mu = case.parameter(ymod1=ymod1, ymod2=ymod2, prat=prat, force1=force1, force2=force2)
